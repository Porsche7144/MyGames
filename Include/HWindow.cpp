...
#if NDEBUG
			SeHWindowPos(hWnd, HWND_TOPMOST, rHWindow.left, rHWindow.top, 0, 0, SWP_NOSIZE);//HWND_TOP
#else
...
void HWindow::MsgEvent(MSG msg)
{
}
bool	HWindow::SeHWindow(HINSTANCE hInstance,const  TCHAR* pTitleName,int iWidth, int iHeight)
{
	...
	GetWindowRect(m_hWnd, &m_rHWindow);
