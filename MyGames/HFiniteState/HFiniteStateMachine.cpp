...
void HFiniteStateMachine::AddStateTrasition(DWORD dwState, DWORD dwEvent, DWORD dwOutputState)
{
...
DWORD HFiniteStateMachine::GetTransition(DWORD dwState, DWORD dwEvent)
{
	return m_mapState[dwState]->m_dwMapList[dwEvent];
}
