...
BEGIN_MESSAGE_MAP(CMainFrame, CFrameWndEx)
	...
	ON_COMMAND(ID_TOOL_CHARACTORTOOL, &CMainFrame::OnToolCharactor)
END_MESSAGE_MAP()
...
int CMainFrame::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
	...
	m_wnModifyPane.CreateEx(NULL, L"MapModifyTool", this,
		CRect(0, 0, 100, 100), TRUE,
		1235, dwStyle);
...
void CMainFrame::OnToolCharactor()
{
	if (m_CharacterDlg.GetSafeHwnd() == NULL)
	{
		m_CharacterDlg.Create(IDD_HCharactorToolDlg);
	}
