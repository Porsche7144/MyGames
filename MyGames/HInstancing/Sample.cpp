...
bool Sample::Render()
{
	...
	//{
		m_pObj.m_pFbxObj->SetMatrix(NULL, &m_pMainCamera->m_matView, &m_pMainCamera->m_matProject);
	...
	if (g_Input.GetKey('1') == KEY_PUSH)
	{
		...
		HDxState::SetRasterizerState(g_pd3dDevice, g_pImmediateContext,
			HDxState::g_RasterizerDesc);
