...
// SampleMFC.cpp: 응용 프로그램에 대한 클래스 동작을 정의합니다.
//
...
BEGIN_MESSAGE_MAP(CSampleMFCApp, CWinAppEx)
...
// CSampleMFCApp 사용자 지정 로드/저장 방법

void CSampleMFCApp::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void CSampleMFCApp::LoadCustomState()
{
}

void CSampleMFCApp::SaveCustomState()
{
}
