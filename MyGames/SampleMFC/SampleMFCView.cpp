...
// SampleMFCView.cpp: CSampleMFCView 클래스의 구현
//
...
BEGIN_MESSAGE_MAP(CSampleMFCView, CView)
	...
	ON_COMMAND(ID_FILE_PRINT_PREVIEW, &CSampleMFCView::OnFilePrintPreview)
	ON_WM_CONTEXTMENU()
	ON_WM_RBUTTONUP()
END_MESSAGE_MAP()

// CSampleMFCView 생성/소멸
...
void CSampleMFCView::OnFilePrintPreview()
{
#ifndef SHARED_HANDLERS
...
void CSampleMFCView::OnRButtonUp(UINT /* nFlags */, CPoint point)
{
	ClientToScreen(&point);
	OnContextMenu(this, point);
}

void CSampleMFCView::OnContextMenu(CWnd* /* pWnd */, CPoint point)
{
#ifndef SHARED_HANDLERS
...
CSampleMFCDoc* CSampleMFCView::GetDocument() const // 디버그되지 않은 버전은 인라인으로 지정됩니다.
{
